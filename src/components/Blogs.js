...
export default function Blogs() {
  ...
  return (
    <div className="inset-x-0 bottom-0 mt-auto  ">
      ...
      >
        {hover ? "Blogs" : "स्वराज्य"}
      </h1>
      <div className="grid  mx-24 mt-12 gap-6 sm:grid-cols-2 xl:grid-cols-3 ">
        {data.map((blog, index) => {
          return (
            <div className="max-[280px]:mx-0 max-[800px]:text-base mb-12 max-w-xs">
              <LazyLoad>
